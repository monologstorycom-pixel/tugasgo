...
export type UserRecord = { id: number; name: string; username: string; role: ApiRole; phone: string | null; active: boolean; availability_status: 'AVAILABLE' | 'ON_LEAVE' | 'OFF_DUTY'; division_name: string | null }
